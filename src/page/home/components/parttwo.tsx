        ...
        <div className="fr">
          ...
          >
            ...
            <p>
              ...
              different lights. Before the souls of the Pandas have yet to
              ascend,
            </p>
            <p>
            ...
            <p>
              Some pandas use the wisdom bestowed by Tim Allen to try to
              establish a way to ascend, and some pandas use their warrior
              spirit and power to guard their territories...
            </p>
          </div>
        </div>
      </div>
